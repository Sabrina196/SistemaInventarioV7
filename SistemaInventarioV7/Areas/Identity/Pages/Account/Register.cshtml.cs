...
namespace SistemaInventarioV7.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "La {0} debe tener un mínimo de {2} y un máximo de {1} caracteres.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //El valor del user que se recibe desde el Page
                    if (user.Role == null)
                    {
                    ...
                    {
                        //Sino se guarda el valor que le asignó el Admin
                    ...
                    else
                    {
                        ...
                        {
                            //El admin esta registrando un nuevo usuario, se mantene su sesión
                            //y se lo redicciona a un módulo de administración de Usuarios
                ...
                //Llenamos nuevamente la listaRol
                Input = new InputModel()
                {
                    ListaRol = _roleManager.Roles.Where(r => r.Name != DS.Role_Cliente).Select(r => r.Name).Select(l => new SelectListItem
                    {
